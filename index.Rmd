 ...
 * **Sampling & pre-processing & smoothing** Shiny applications uses quad-, tri-, and bigrams from a 20% sampling of a corpus of articles, blog posts and tweets.  Preprocessing removes profanity, punctuation, numbers and foreign characters.  
 ...
 * **Testing and performance reporting**  First-word and In-top-3-word acccuracy calculations as well as mean query time provide ability to compare and contrast model configurations.  
